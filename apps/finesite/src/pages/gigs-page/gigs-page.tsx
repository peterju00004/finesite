  ...
  return (
    <div className={styles['gigs-page']}>
      ...
      <p className={styles['gigs-description']}>
        I played as a keyboardist with Sennight and AED. These videos inform how I think about real-time interaction, collaboration, and the gap between practice and performance.
      </p>
